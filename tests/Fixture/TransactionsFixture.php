...
class TransactionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'transactions_ibfk_1' => ['type' => 'foreign', 'columns' => ['customer_id'], 'references' => ['customers', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'transactions_ibfk_2' => ['type' => 'foreign', 'columns' => ['sales_outlet_id'], 'references' => ['sales_outlets', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'transactions_ibfk_3' => ['type' => 'foreign', 'columns' => ['staff_id'], 'references' => ['staffs', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'sales_outlet_id' => 1,
            'staff_id' => 1,
            'transaction_date_time' => '2016-11-02 20:19:02',
