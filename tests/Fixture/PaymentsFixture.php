...
class PaymentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'payment_method_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'payment_method_code' => ['type' => 'index', 'columns' => ['payment_method_id'], 'length' => []],
            'transaction_id' => ['type' => 'index', 'columns' => ['sales_transaction_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'payments_ibfk_1' => ['type' => 'foreign', 'columns' => ['sales_transaction_id'], 'references' => ['transactions', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'payments_ibfk_2' => ['type' => 'foreign', 'columns' => ['payment_method_id'], 'references' => ['payment_methods', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
